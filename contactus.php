...
<div class="col-md-4">
 <p><strong>Address:</strong> 
   ...
   <p>Shabana Foundations</p>
   <p>#12-1-1061/3/1, Near Jamai Masjid,<br> North Lalaguda, Hyderabad,<br>  Telangana, India.</p>
    <p><strong>Conatct Person:</strong> Ms. Shabana Begum(President)</p>
    <p>      <strong>Mobile No.:</strong> +91 9100823370</p>
    <p>      <strong>Helpline: </strong>+91 8801016951 / 9553267531</p>
    <p><strong>Email-id:</strong> info@shabanafoundations.com</p>
</div>
<div class="col-md-4">
<img src="images/contact-us.png" class="img-responsive pull-right" style="margin-left:15px;"/>
</div>
...
<div class="col-md-4">
      ...
      <div class="form-group">
        <div class="col-sm-12">
          <textarea class="form-control required" name="comments" id="comments" rows="3" placeholder="Comments"></textarea>
        </div>
      </div>
      <div class="form-group">
        <div class="col-sm-12">
