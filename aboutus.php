...
<section class="bigMessage">
  <div class="container">
    ...
    <p><img src="images/about-img.jpg" class="img-responsive pull-right" style="margin-left:15px;"/>Ms. Shabana begum is actively involved in social service  since 11 years. She is a fashion designer by profession  &amp; also an active women right member.</p>
    <p>      M/s best enterprises in lalaguda is the supportive firm to  the foundation.</p>
    <p>      <strong>Note: </strong></p>
    <p>Any person can consult anytime with prior appointment  to discuss all related problems.</p>
    <br><br>
    <div class="row">
    <div class="col-md-3">
    <p>1. Dowry  Harrasment </p>
    <p>      2. Domestic  Violence</p>
    <p>      3. Mental  Torture</p>
    <p>      4. Physically  Abuse </p>
    <p>      5. Sexual  Assault</p>
    </div>
    <div class="col-md-3">
    <p>6. Senior  Citizen Rights</p>
    <p>      7. Women  Property Rights</p>
    <p>      8. Maintainence  Rights</p>
    <p>      9. Parents  Rights </p>
    <p>      10. Child  Rights</p>
    </div>
    <div class="col-md-3">
     <p>11. Marriage  Problems</p>
     <p>       12. Issue Of  Love</p>
     <p>       13. Problem@Work  Place</p>
     <p>       14. Extra  Material  Problems</p>
     <p>       15. Second  Marriage, Divorce</p>
    </div>
    <div class="col-md-3">
    <a href="images/home-img1-big.jpg" target="_blank"><img src="images/home-img1.jpg" class="img-responsive pull-left" style="margin-right:15px;"/></a>
    </div>
